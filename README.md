...
**SimpleApp** is an android app that allows building a todo list and basic todo items management functionality including adding new items, editing and deleting an existing item.

Submitted by: **Elaheh Jamali**
...
<img src='https://github.com/Jamaliela/SimpleApp/blob/master/simpleapp.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
